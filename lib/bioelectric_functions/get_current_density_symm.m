function iap = get_current_density_symm(t, z, zi, L1, L2, v, d, suppress_endplate_density, endplate_width)
...
% bigger and two times faster than analytical one.
...
iap = iap * sigma_i * pi*((d/2)^2)/4; % This formula is consistent with Hamilton-Wrigth's model
                                      % Only difference, it's the radius
