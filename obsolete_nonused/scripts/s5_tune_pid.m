...
pid_ident_spikes = generate_spike_train_vect(1:sys_T, nan(N,1), sys_ident_excitation, rt, minfr, maxfr, frs, CV, fs);
pid_valid_spikes = generate_spike_train_vect(1:sys_T, nan(N,1), sys_valid_excitation, rt, minfr, maxfr, frs, CV, fs);
